...
TEST(http_server, headers) {
    ...
    tcpserver->set_handler({server, &HTTPServer::TCPHandler});
...
TEST(http_server, proxy_handler) {
    ...
    tcpserver->set_handler({proxy_server, &HTTPServer::TCPHandler});
    tcpserver->start_loop();
    //----------------------------------------------------
...
TEST(http_server, mux_handler) {
    ...
    tcpserver->set_handler({mux_server, &HTTPServer::TCPHandler});
    tcpserver->start_loop();
    //----------------------------------------------------
    //--------------test static service--------------------
